      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.centerWrap}>
          ...
          <View style={styles.card}>
            <Text style={styles.title}>Trust your instinct</Text>

            <Text style={styles.body}>
              Quick decisions. No time to overthink.{'\n'}
              Swipe left or right and see if your choices are truly eco-friendly.
            </Text>
...
const styles = StyleSheet.create({
  ...
  centerWrap: {
    ...
    marginTop: isVerySmall ? -12 : isSmall ? -18 : -24,
  },
